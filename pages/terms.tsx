                        ...
                        <div className="module-content__left">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div>
                                        4.2.
                                        作品必須依照大會指定方法及格式遞交，否則可被取消資格。
                                    </div>
                                    <div>
                                        4.3. 參賽作品如包括文字，須使用中文。
                                    </div>
                                    <div>
                                        4.4. 每隊參賽隊伍只可提交一份參賽作品。
                                    </div>
                                    <div>
                                        4.5.
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div>
                                        5.6.
                                        所有與比賽相關攝影、錄像和錄音的權利均歸大會所有。
                                    </div>
                                    <div>
                                        5.7. 參賽學校老師將作為比賽報名者，
                                        報名即視為承諾已經取得該校參賽學生的法定監護人對該學生在報名老師註冊的通義帳號下使用通義平台為參賽的同意。
                                        老師將對其帳號的註冊和使用負全責，包括但不限於參賽相關操作、資料輸入、賬戶登入和安全。
                                    </div>
                                    <div>
                                        5.8.
                                        參賽者及報名者須仔細閱讀比賽條款及細則。參賽隊伍的報名者遞交報名後即表示同意遵守及接受
                                        <a
